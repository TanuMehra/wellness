...
import { Edit, Save, X, Camera, User, Calendar, Heart, Briefcase, Loader2 } from 'lucide-react'
...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  const handleSave = async () => {
    if (!token) {
      Swal.fire('Authentication Error', 'Could not find authentication token. Please log in again.', 'error')
      return
    }
